$(function ($) {
    $('body').on('click', '#fillSuggestData', function (e) {
        suggestTitleBooks();
    });
    
    $('body').on('click', '.suggestedTitle', function (e) {
        suggestDataBooks();
    });
    ...
    $('body').on('keyup', '.title-book', function (e) {
        delay(function(){
            e.preventDefault();
...
if (typeof suggestTitleBooks === 'undefined') {
